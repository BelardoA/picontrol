...
subprocess.Popen('python3 /home/pi/scripts/picontrol/picontrol_fan.py&', shell=True)

#start webserver
os.system('pkill -9 -f picontrol_web.py')
os.system('sudo iptables -A PREROUTING -t nat -p tcp --dport 80 -j REDIRECT --to-port 8080')
subprocess.Popen('python3 /home/pi/scripts/picontrol/webserver/picontrol_web.py&', shell=True)
...
if buttonOption == 1:
    subprocess.Popen('python3 /home/pi/scripts/picontrol/picontrol_button_classic.py&', shell=True)
else:
    subprocess.Popen('python3 /home/pi/scripts/picontrol/picontrol_button_pi.py&', shell=True)
